...
void TerrainLitShade(FragInputs input, inout TerrainLitSurfaceData surfaceData, PositionInputs posInput);
...
void GetSurfaceAndBuiltinData(inout FragInputs input, float3 V, inout PositionInputs posInput, out SurfaceData surfaceData, out BuiltinData builtinData)
{
    ...
    TerrainLitShade(input, terrainLitSurfaceData, posInput);
