...
namespace Digger
{
    ...
    internal struct MarchingCubesJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            {
                N0 = ComputeNormalAt(xi, yi, zi, v0.Value),
                N1 = ComputeNormalAt((xi + lod), yi, zi, v1.Value),
                N2 = ComputeNormalAt((xi + lod), yi, (zi + lod), v2.Value),
                N3 = ComputeNormalAt(xi, yi, (zi + lod), v3.Value),
                N4 = ComputeNormalAt(xi, (yi + lod), zi, v4.Value),
                N5 = ComputeNormalAt((xi + lod), (yi + lod), zi, v5.Value),
                N6 = ComputeNormalAt((xi + lod), (yi + lod), (zi + lod), v6.Value),
                N7 = ComputeNormalAt(xi, (yi + lod), (zi + lod), v7.Value)
            };
